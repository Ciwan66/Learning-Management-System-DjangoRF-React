...
function TeacherVerticalCard({ course ,DeleteCourse }) {
  return (
    <Card
    sx={{
      boxShadow: 0,
  ...
  >
    ...
    <Box sx={{ display: "flex" }}>
      ...
      <Box component={Link} to={`/course/detail/${course.id}`} sx={{textDecoration: 'none',ml:5}}>
      {" "}
        <Typography
          color="text.primary"
          sx={{
...
export default TeacherVerticalCard